...
function setupGithub({ server, ROOT_URL }) {
    const verify = async ({ user, accessToken, profile }) => {
        // console.log("github-setupGithub-verify user", user)
        // console.log("github-setupGithub-verify accessToken", accessToken)
        // console.log("github-setupGithub-verify profile", profile)
...
// module.setupGithub = setupGithub
// module.getRepos = getRepos
// module.getRepoDetail = getRepoDetail
// module.getCommits = getCommits